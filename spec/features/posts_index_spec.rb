...
RSpec.describe 'Integration tests for Post#Index', type: :feature do
  describe 'Post Home page' do
    before :each do
      ...
      @first_post = Post.create!(author: @first_user, title: 'Post 1', text: 'This is my new post', comment_counter: 0,
                                 like_counter: 0)
      @second_post = Post.create!(author: @first_user, title: 'Post 2', text: 'This is my new post',
                                  comment_counter: 0, like_counter: 0)
      @third_post = Post.create!(author: @first_user, title: 'Post 3', text: 'This is my new post', comment_counter: 0,
                                 like_counter: 0)
